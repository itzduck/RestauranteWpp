...
const whatsappLinkGenerator = (phoneNumber, productTitle, productQuantity, buyerName, buyerAddress, buyerPayment) => `https://api.whatsapp.com/send?phone=
${phoneNumber}&text=Olá, gostaria de pedir: ${productQuantity} ${productTitle} - Entregar para ${buyerName}
no endereço: ${buyerAddress} - A forma de pagamento será: ${buyerPayment}.`
...
const checkout = phoneNumber =>{
    ...
    form.addEventListener('submit', e => {
        ...
        const whattsappUrl = whatsappLinkGenerator(phoneNumber, productTitle, productQuantity, buyerName, buyerAddress, buyerPayment)

        window.location.href = whattsappUrl
    })
} 
